...
In the paper ``The Pricing of Options and Corporate Liabilities'', \aycite{black-scholes} provide a replicating argument as to the price of the derivative. The underlying idea behind their model is that.
