...
Equation (\ref{eq:risk-neutral-price}) For much more complex claims $C$ under the Black-Scholes model there may not exist a closed form formula such as the European call option $\callPayoff{S_T}$
\begin{figure}[h!]
