...
Likewise, another far-reaching result is presented in the following definition:
...
Finally, we reach the last key theorem necessary to price the option. The following 
