...
\begin{align}
	...
	&= \theta(t)\nu(t)\left[dX(t) - X(t)\rho(t)dt\right]\nonumber\\
...
%TODO: we are considering a model with two components, namely, the risk free asset and the risky asset from which we will derive the price from. Since this market is normalized, then we only consider the asset as the risky stock in this market.xxxxxx
