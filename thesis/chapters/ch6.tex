...
\begin{align}
	...
	&= \nu(t)\theta(t)d\XBar(t).\label{eq:change_norm_value_process}
\end{align}
...
\begin{proof}
	...
	Since we want $C(t, S_t)$ to tbe the value of the self-financing portfolio that attains the claim at time $T$. Then, $C(0, S_0)$ must be the replication cost, i.e., the value of the option at $t=0$. 
\end{proof}
\end{document}