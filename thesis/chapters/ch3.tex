...
Feasible as this may seem, as pointed out by \aycite{baxter}, this approach could lead to disaster for the financial institution. Nonetheless, by following no-arbitrage arguments, it can be shown that the the price of a forward is the discounted value of the current price of the stock.\\
