...
% TODO: write about what's to expect about this chapter. The first part
% will relax riguourous assumptions in order to build an intuition of
% how to get to the brownian motion from a simpe random walk.
% The second part will prove some important elements of the brownian motion
% finally, how to get to the geometric browianian motion
