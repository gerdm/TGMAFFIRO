...
Theorem \ref{th:convergence_rw} shows the distribution that follows if we assume that the market moves continuously. The process that emerges from this assumption  

%%% Scaled Random Walk figure %%%
\begin{figure}[h]
	\label{arithmetic_brownian_motion}
	\centering
	\includestandalone{images/standard_bw}
